          ...
          <div className="hero-right">
            <div className="hero-content">
              ...
              <div className="middle-nav-links">
                <NavLink to="/resume" className="circle" style={{ backgroundColor: '#e0a458' }}>
                  <span className="tag">Resume</span>
                </NavLink>
                <NavLink to="/project" className="circle" style={{ backgroundColor: '#d9594c' }}>
                  <span className="tag">Work</span>
                </NavLink>
                <NavLink to="/contact" className="circle" style={{ backgroundColor: '#419d78' }}>
